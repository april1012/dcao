...
<nav class="navbar navbar-light bg-primary fixed-top">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="font: size 1rem;">
    <li><a class="dropdown-item" href="update_profile.php" style="font-size: 14px;"><i class="bi bi-gear"></i> Update Profile</a></li>
...
<div class="navigation float-left" >
  ...
  <div class=image>
    <?php
            $conn = mysqli_connect($localhost, $user, $pass, $database);
            $q = mysqli_query($conn,"SELECT image FROM users WHERE username = '".$_SESSION['username']."'");
...
<br><br>
    ...
    <div class="container float-right">
                ...
                <p class="text-right"><a href="home_user.php">Today</a></p>
