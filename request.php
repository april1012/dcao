            ...
            <?php
                ...
                while($main_result = mysqli_fetch_assoc($sql_get)) :?>
                    <tr>
                        ...
                        <td name="actions">
                        <button class="btn btn-primary btn-sm" ><a class="text-light" style="text-decoration:none;" href="accept_request.php?id=<?php echo $main_result['id']; ?>">Accept</a></button>
                            <button class="btn btn-danger btn-sm" ><a class="text-light" style="text-decoration:none;" href="delete_request.php?id=<?php echo $main_result['id']; ?>">Reject</a></button>
                        </td>
                    </tr>
            <?php endwhile ?>
  </tbody>
