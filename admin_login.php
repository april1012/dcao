...
<body>
      ...
      <div class="container">
          <form action="" method="POST" class="login-username">
              <p class="login-text" style="text-align: center;font-size: 2rem; font-weight:800;">Admin Login</p>
              ...
              <p class="login-register-text" style="text-align:center;"><a href="index.php">Go to Main Page</a></p>
          </form>
      </div>
