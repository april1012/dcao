    ...
    if (isset($_POST['submit'])){ 
        ...
        if (isset($_POST['tax_declaration'])){
            ...
            $tax_declaration = "NO";
                ...
                $query = "INSERT INTO verification_of_pin (firstname,middlename,lastname,email,contact, address, requestor,filled_request_form,authorization_letter,valid_id,title_property,tax_declaration)
                        VALUES ('$firstname','$middlename','$lastname','$email','$contact', '$address', '$requestor','$filled_request_form','$authorization_letter','$valid_id','$title_property','$tax_declaration')";
