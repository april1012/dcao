    ...
    if (isset($_POST['submit'])){ 
        ...
        if (isset($_POST['pin'])){
            ...
            $pin = "NO";
                ...
                $query = "INSERT INTO c_no-improvement (firstname,middlename,lastname,email,contact, address, requestor,filled_request_form,authorization_letter,valid_id,pin)
