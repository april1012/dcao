...
<?php 
            if (isset($_POST["update"])){
                ...
                $q = mysqli_query($conn,"UPDATE admin SET image = '".$_FILES ["file"]["name"]."' WHERE username = '".$_SESSION['username']."'");
            }
            ?>
...
<nav class="navbar navbar-light bg-primary fixed-top">
  <div class="container-fluid">
    ...
    <div class="greetings">
  <p class="greet"><em>Welcome Admin!</em></p>
</div>
<?php
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="font: size 1rem;">
    <li><a class="dropdown-item" href="admin_logout.php"><i class="bi bi-power"></i> Sign Out</a></li>
  </ul>
</div>
    <!-- <p class="main-page-text"><a href="home.php">Go back</a></p> -->
    </div> 
  </div>
</nav>
<br>
...
<div class="navigation float-left" >
  ...
  <div class=image>
    <?php
            $conn = mysqli_connect($localhost, $user, $pass, $database);
            $q = mysqli_query($conn,"SELECT image FROM admin WHERE username = '".$_SESSION['username']."'");
    ...
    <h5>OVERVIEW</h5>
    <a class="nav-link" href="request_admin.php">Requests</a>
    <a class="nav-link" href="appointments_admin.php">Appoinments List</a>
    <a class="nav-link" href="staff_list.php">Staffs List</a>
<br><br>
<br><br>
<br><br>
<br><br>
    ...
    <div class="container float-right">
                ...
                <p class="text-right"><a href="admin.php">Today</a></p>
