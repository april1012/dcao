    ...
    if (isset($_POST['submit'])){ 
        ...
        if ($password == $cpassword) {
            ...
            if(!$result->num_rows > 0) {
                $sql = "INSERT INTO staff (firstname,middlename,lastname, username,email,contact, password)
...
<body>
      <div class="container">
          <form action="" method="POST" class="login-username">
              <p class="login-text" style="text-align: center; font-size: 2rem; font-weight:800;">Staff Register</p>
              ...
              <div class="btn">
                <p class="main-page-text"><a href="staff_list.php">Go back</a></p>
            </div> 
          </form>
